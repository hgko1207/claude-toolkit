...
이 가이드라인은 [tips/templates/](templates/) 폴더의 CLAUDE.md 템플릿과 결합해서 쓰면 더 강력합니다.

| 결합 | 효과 |
|------|------|
| 카파시 4원칙 + [CLAUDE-vibe.md](templates/CLAUDE-vibe.md) | 바이브 코딩 + 브레이크 |
| 카파시 4원칙 + [CLAUDE-web.md](templates/CLAUDE-web.md) | 웹 개발 스택 + 행동 원칙 |
| 카파시 4원칙 + [hooks-guide.md](hooks-guide.md) | 행동 원칙 + 자동 검증 훅 |
